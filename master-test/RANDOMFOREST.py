...
prediction= RandomForestRegModel.predict(X_test) 
print(RandomForestRegModel.score(X_test, y_test))
...
# one parmetre
start_time = time.time() 
regg1 = RandomForestRegressor(n_estimators=100)
...
#with 2
start_time = time.time()
regg2 = RandomForestRegressor(n_estimators=100)
...
#with 
start_time = time.time()
regg3 = RandomForestRegressor(n_estimators=100)
...
#with 4
start_time = time.time()
regg4 =RandomForestRegressor(n_estimators=75)
...
#with 5
start_time = time.time()
regg5 = RandomForestRegressor(n_estimators=100)
...
#♣with 6
start_time = time.time()
regg6 = RandomForestRegressor(n_estimators=100)
...
#with 7
start_time = time.time()
regg7 = RandomForestRegressor(n_estimators=100)
...
#with the first corr
start_time = time.time()
regg8 = RandomForestRegressor(n_estimators=100)
...
#with the best corr
start_time = time.time()
regg9 = RandomForestRegressor(n_estimators=100)
...
#best 3 corr
start_time = time.time()
regg10 = RandomForestRegressor(n_estimators=100)
regg10.fit(X_train[['Net Rad (W/sq.m)','Sol Rad (W/sq.m)','Avg Soil Temp (C)']], y_train)
prediction10 = regg10.predict(X_test[['Net Rad (W/sq.m)','Sol Rad (W/sq.m)','Avg Soil Temp (C)']])
print (regg10.score(X_test[['Net Rad (W/sq.m)','Sol Rad (W/sq.m)','Avg Soil Temp (C)']],y_test))
print("--- %s seconds ---" %(time.time() -  start_time))
...
#plot
a = plt.axes(aspect='equal',)
plt.scatter(y_test,prediction10,color='red')
plt.xlabel('True Values ETo')
